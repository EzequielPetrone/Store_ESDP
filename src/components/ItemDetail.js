    ...
    return (
        <div className="flex flex-col sm:flex-row items-center w-fit border-solid border-gray-200 border-2 shadow-lg p-2 rounded-xl">
            ...
            <div className="w-64">
                ...
                <div>
                    <button className="bg-gray-900 text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium"
                        disabled={cartBtnDisabled} onClick={addToCart}>
                        Agregar carrito
                    </button>
                </div>
            </div>
